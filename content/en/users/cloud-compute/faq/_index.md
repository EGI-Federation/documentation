...
device and attaching it to the VM. Check the [storage guide](../../online-storage)
...
- Use a volume to store the data to be kept: Check the
  [Storage section of the documentation](../../online-storage/block-storage) to learn how to use
