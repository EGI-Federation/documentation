...
linkTitle: "Create your first Virtual Machine"
type: docs
weight: 70
description: >
  Step by step guide to get your first VM up and running
---
...
## Step 2: Enroll a Virtual Organisation
...
for piloting purposes so if you are not sure about what VO to enroll please request
...
Service in EGI please visit its dedicated section in the [docs](../../cloud-compute).
